...
{ art:"312", nome:"Inovar artificiosamente em local de acidente com vítima", tipificacao:"Inovar artificiosamente, em caso de acidente automobilístico com vítima, na pretensão de segurar direito ou eximir-se de dever, o estado de lugar, de coisa ou de pessoa, a fim de induzir a erro o agente policial, o perito ou o juiz.", pena:"Detenção de 6 meses a 1 ano, ou multa.", procedimento:"Atenção para alteração de posição de veículos/objetos no local antes da chegada da perícia — orientar envolvidos a não mexer em nada até liberação da autoridade competente." }
];

// ---------------- PROCEDIMENTOS OPERACIONAIS PADRÃO (POPs) DE OCORRÊNCIA ----------------
const PROCEDIMENTOS = [
{
  titulo: "Acidente de trânsito com vítima",
  passos: [
...
{
  titulo: "Fuga do local do acidente (evasão)",
  passos: [
